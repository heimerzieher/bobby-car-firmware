...
// Limitation settings
#define I_MOT_MAX       12              // [A] Maximum motor current limit
#define I_DC_MAX        14              // [A] Maximum DC Link current limit (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A)
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  //#define ADC_PROTECT_ENA               // ADC Protection Enable flag. Use this flag to make sure the ADC is protected when GND or Vcc wire is disconnected
  //#define ADC_PROTECT_TIMEOUT 30        // ADC Protection: number of wrong / missing input commands before safety state is taken
  //#define ADC_PROTECT_THRESH  199       // ADC Protection threshold below/above the MIN/MAX ADC values
  #define ADC1_MIN            100       // min ADC1-value while poti at minimum-position (0 - 4095)
  #define ADC1_MAX            1200      // max ADC1-value while poti at maximum-position (0 - 4095)
  #define ADC2_MIN            100       // min ADC2-value while poti at minimum-position (0 - 4095)
  #define ADC2_MAX            1200      // max ADC2-value while poti at maximum-position (0 - 4095)
